...
class rolling_curl
{
    ...
    public function request($url, $method = "GET", $fields = [], $headers = [], $options = [])
    {
     ...
     * @return bool
     */
    public function get($url, $fields = [], $headers = [], $options = [])
    {
     ...
     * @return void
     */
    public function post($url, $fields = [], $headers = [], $options = [])
    {
